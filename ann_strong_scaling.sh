...
export UW_SCRIPT="annulus_sum_660.py"
export UW_DIM=2
export NAME="Results_strong_${UW_NAME}_DIM_${UW_DIM}_BASE_${STRONG_SCALING_BASE}_ORDER_${UW_ORDER}_TOL_${UW_SOL_TOLERANCE}_PENALTY_${UW_PENALTY}_IO_${UW_ENABLE_IO}"
